...
\begin{prop}[作用素ノルムの明示公式]\proplabel{実ノルム-作用素ノルム具体形}
    ...
    \begin{proof}
        ...
        このとき，$Ax$の第$j$成分$\pare{Ax}^j$に関して，
        \begin{equation}
            \abs{\pare{Ax}^j}=\abs{\sum_{k=0}^{n-1}a^j_k x^k}
...
\begin{prop}[作用素ノルムの不等式1]\proplabel{実ノルム-作用素ノルム不等式1}
    ...
    \begin{proof}
        ...
        $Ax$の第$j$成分について，
        \begin{equation}
            \abs{\pare{Ax}^j}=\abs{\sum_{k=0}^{n-1}a^j_kx^k}
...
\subsection{無限和と一様収束性}\subseclabel{一様収束-無限和と一様収束}
...
\begin{thm}[Weierstrassの$M$判定法]\thmlabel{一様収束-WeierstrassのM判定法}
