...
\begin{defi}[$L^\infty$ノルム]\defilabel{実ノルム-Linftyノルム}
    $A$を$\R^m$上の区間とし，$f\colon A\to \R^n$とする。
    $f$のノルム$\norm{f}_\infty$を，
    \begin{equation}
...
\begin{defi}[各点収束・一様収束]\defilabel{一様収束-各点収束と一様収束の定義}
    ...
    また，各自然数$n$に対し，$f_n\colon I\to \R$による関数列$\seq{f_n}{n\in\N}$を考える。
    関数列$\seq{f_n}{n\in\N}$が$A$上で$f$に各点収束するとは，
    \begin{equation}
        \forall\varepsilon\in\Rposi,\,\forall x\in I,\, \exists N\in\N;\ \bsqu{
            \forall n\in \N,\, \pare{N\leq n\ \Longrightarrow\ \norm{\fun{f_n}{x}-\fun{f}{x}}<\varepsilon}
        }
    \end{equation}
    が成立することである。
    また，関数列$\seq{f_n}{n\in\N}$が$A$上で$f$に一様収束するとは，
    \begin{equation}
        \forall\varepsilon\in\Rposi,\, \exists N\in\N;\, \forall x\in I,\ \bsqu{
            \forall n\in \N,\, \pare{N\leq n\ \Longrightarrow\ \norm{\fun{f_n}{x}-\fun{f}{x}}<\varepsilon}
        }
...
\begin{lem}\lemlabel{一様収束-forallの順序交換}
...
\begin{prop}
    ...
    \begin{equation}
        \forall\varepsilon\in\Rposi,\, \exists N\in\N;\ \bsqu{
    ...
    \begin{proof}
        ...
        \begin{align}
            ...
            \Longleftrightarrow\
            &\forall\varepsilon\in\Rposi,\, \exists N\in\N;\ \bsqu{
                \forall n\in\N,\, \pare{N\leq n\ \Longrightarrow\ \forall x\in A,\, \norm{\fun{f_n}{x}-\fun{f}{x}}<\varepsilon}
            }
            \\
            \Longleftrightarrow\
            &\forall\varepsilon\in\Rposi,\, \exists N\in\N;\, \forall x\in I,\ \bsqu{
