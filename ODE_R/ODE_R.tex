...
\begin{prop}\proplabel{ノルムpノルムが一様ノルムに収束する}
    ...
    \begin{proof}
        ...
        示すべきことは，
        \begin{equation}
            \pare{\sum_{k=0}^{n-1}\abs{x_k}^p}^{\frac{1}{p}}\longrightarrow \abs{x_M}\quad\pare{p\to\infty}
            \equlabel{ノルムpノルムの極限}
        \end{equation}
        である。
        まず，$1<p<\infty$のとき，$\norm{x}_\infty \leq \norm{x}_p$であることを確かめる。
        ...
        \begin{equation}
            \pare{\abs{x_M}^p}^{\frac{1}{p}}=\abs{x_M}\leq \pare{\sum_{k=0}^{n-1}\abs{x_k}^p}^{\frac{1}{p}}
        \end{equation}
        より成立。
        ...
        更に，$n$は固定された正整数であるから
        \begin{equation}
            n^{\frac{1}{p}}\longrightarrow n^0=1\quad\pare{p\to\infty}
        \end{equation}
        である。
        ...
        \begin{equation}
            ...
            \longrightarrow 0\quad\pare{p\to\infty}
        \end{equation}
        が従い，はさみうちの原理から，
        \begin{equation}
            \pare{\sum_{k=0}^{n-1}\abs{x_k}^p}^{\frac{1}{p}}\longrightarrow \abs{x_M}\quad\pare{p\to\infty}
